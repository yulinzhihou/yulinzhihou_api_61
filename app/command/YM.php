...
class YM extends Make
{
    ...
    public function getField($db) : array
    {
        ...
        foreach ($columnList as $column) {
            ...
            $schemas[$column['COLUMN_NAME']] = $column['DATA_TYPE'];
        }
    ...
    protected function buildClass(string $name): string
    {
        ...
        $schema = $this->buildHtmlText($fileds['schemas']);

        return str_replace(['{%baseNamespace%}','{%className%}','{%modelNamespace%}','{%validateNamespace%}', '{%namespace%}', '{%app_namespace%}','{%schema%}'], [
            $baseNamespace,
            $class,
            $baseNamespace.'\model',
