...
class MonsterCreate extends Migrator
{
    ...
    {
        $table = $this->table('monster',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','charset'=>'utf8mb4','collation'=>'utf8mb4_general_ci','comment'=>'怪物NPC表']);
        $table
            ->addColumn('monster_id','integer',['limit'=>10,'signed'=>true,'null'=>false,'default'=>0,'comment'=>'怪物编号'])
            ...
            ->addColumn('name_table_height','decimal',['precision'=>10,'scale'=>2,'null'=>false,'default'=>0.00,'comment'=>'名字板高度'])
            ->addColumn('select_circle','decimal',['precision'=>10,'scale'=>2,'null'=>false,'default'=>0.00,'comment'=>'选中环大小'])
            ->addColumn('shadow_size','decimal',['precision'=>10,'scale'=>2,'null'=>false,'default'=>0.00,'comment'=>'阴影大小'])
