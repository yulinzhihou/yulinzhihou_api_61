...
class EquipBaseCreate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('equip_base',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','charset'=>'utf8mb4','collation'=>'utf8mb4_general_ci','comment'=>'装备表']);
        $table
            ->addColumn('equip_id','integer',['limit'=>10,'signed'=>true,'null'=>false,'default'=>0,'comment'=>'装备编号'])
