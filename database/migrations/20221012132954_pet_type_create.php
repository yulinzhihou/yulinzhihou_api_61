...
class PetTypeCreate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('pet_attr',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','charset'=>'utf8mb4','collation'=>'utf8mb4_general_ci','comment'=>'珍兽表']);
        $table
            ->addColumn('pet_id','integer',['limit'=>10,'signed'=>true,'null'=>false,'default'=>0,'comment'=>'珍兽编号'])
