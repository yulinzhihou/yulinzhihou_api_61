...
class CommonItemCreate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('common_item',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','charset'=>'utf8mb4','collation'=>'utf8mb4_general_ci','comment'=>'物品表']);
        $table
            ->addColumn('item_id','integer',['limit'=>10,'signed'=>true,'null'=>false,'default'=>0,'comment'=>'物品编号'])
