...
class GemInfoCreate extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('gem_info',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','charset'=>'utf8mb4','collation'=>'utf8mb4_general_ci','comment'=>'宝石表']);
        $table
            ->addColumn('gem_id','integer',['limit'=>10,'signed'=>true,'null'=>false,'default'=>0,'comment'=>'宝石编号'])
